document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            setTimeout(() => {
                showNotification('¡Consulta enviada con éxito! Te contactaremos pronto.', 'success');
                this.reset();
            }, 2000);
        });
    }
    ...
    if (newsletterForm) {
        newsletterForm.addEventListener('submit', function(e) {
            ...
            showNotification('¡Suscrito al newsletter con éxito!', 'success');
            this.reset();
        });
    }
    ...
    console.log('🚀 Diego Beltramo Bitcoin - Página web cargada exitosamente!');
});
